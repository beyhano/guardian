...
| `judgment-day` | Trigger: judgment day, dual review, adversarial review, juzgar. Run blind dual review, fix confirmed issues, then re-judge. | user | `C:\Users\beyhan\.config\opencode\skills\judgment-day\SKILL.md` |
